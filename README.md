...
5. **Enforces OWASP security** — Top 10 + LLM Application Top 10 checklists on every change
6. **Enforces quality gates** — tests mandatory, lint clean, format clean, TypeScript clean, solution justification, British English

## Prerequisites

| Dependency | Required | Install |
|-----------|----------|---------|
| [superpowers plugin](https://github.com/anthropics/claude-code) | Yes | Comes with Claude Code |
| [Context7 MCP](https://github.com/upstash/context7) | Yes | `npx ctx7 setup --claude` |
| [Vercel plugin](https://github.com/anthropics/claude-code) | Recommended | Provides shadcn + react-best-practices skills |
...
```
 ...
 6. SECURITY     → OWASP + LLM security checklist
 7. IMPLEMENT    → superpowers:test-driven-development
 8. VERIFY       → superpowers:verification-before-completion + quality gates
...
- **[Quality Gates](skills/maestro/references/quality-gates.md)** — testing, linting, code quality, solution justification, style, git workflow
