...
- [ ] **Evidence ledger current** — every gate's EVIDENCE filled from fresh output or explicitly abandoned with a reason (`references/evidence-ledger.md`; non-trivial engineering tasks only)
